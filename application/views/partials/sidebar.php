<div class="navbar-default sidebar item-show" role="navigation" style="overflow: visible;">
            <div class="slimScrollDiv" style="position: relative; overflow: visible; width: auto; height: 100%;"><div class="sidebar-nav slimscrollsidebar" style="overflow: visible hidden; width: auto; height: 100%;">
                ...
                <ul class="nav in" id="side-menu">
                    ...
                    <li class="accordion-group">
                        ...
                        class="accordion-toggle waves-effect"
                        data-toggle="collapse"
                        data-parent="#acc" style="padding: 15px 35px 15px 20px;display: block;"
                        href="#resources">
                    ...
                    <div class="accordion-inner">
                        <ul class="nav" style="margin-left:25%!important;">
                            ...
                            <li>
                                <a href="<?php echo base_url();?>index.php/reportes/fecha" class="waves-effect">Vacunos por fecha</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>index.php/reportes/vendidos" class="waves-effect">Ventas por fecha</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>index.php/reportes/edad" class="waves-effect">Vacunos por edad</a>
                            </li>
                            </ul>
                        </div>
                    </div>
